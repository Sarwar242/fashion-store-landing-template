...
$connectStatus = "Database Connected Successfully to: " . getenv('DB_HOST') . " | Database: " . getenv('DB_NAME');
?>
...
<head>
  <title>Fashion Store - Modern E-commerce Template</title>
  <meta charset="utf-8">
  ...
  <meta name="description" content="Modern Fashion Store E-commerce Template">
          ...
          <article class="post-item">
            ...
            <div class="post-content d-flex flex-wrap gap-2 my-3">
              <div class="post-meta text-uppercase fs-6 text-secondary">
                ...
                <span class="meta-day"> Jan 15, 2026</span>
              </div>
        ...
        <div class="col-md-4">
          <article class="post-item">
            ...
            <div class="post-content d-flex flex-wrap gap-2 my-3">
              <div class="post-meta text-uppercase fs-6 text-secondary">
                <span class="post-category">Fashion /</span>
                <span class="meta-day"> Jan 20, 2026</span>
              </div>
              <h5 class="post-title text-uppercase">
        ...
        <div class="col-md-4">
          <article class="post-item">
            ...
            <div class="post-content d-flex flex-wrap gap-2 my-3">
              <div class="post-meta text-uppercase fs-6 text-secondary">
                <span class="post-category">Fashion /</span>
                <span class="meta-day"> Jan 25, 2026</span>
              </div>
              <h5 class="post-title text-uppercase">
      ...
      <div class="row d-flex flex-wrap justify-content-between py-5">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-004 border-animation-left">
            ...
            <p>Do you have any questions or suggestions? <a href="mailto:support@fashionstore.com"
                class="item-anchor">support@fashionstore.com</a></p>
            <p>Do you need support? Give us a call. <a href="tel:+1-800-555-0123" class="item-anchor">+1 (800) 555-0123</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 text-end">
            <p>© Copyright 2026 Fashion Store. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
